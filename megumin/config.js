...
global.owner = [
   // <-- Número @lid -->
   ['5535998872868', '𝘾𝙍𝞝𝞓𝘿𝞗𝙍 (◣_◢)凸', true],
   ["5535998872868"],

   // <-- Número @s.whatsapp.net -->
  ['5535998872868', '🔥 𝗖𝗿𝗲𝗮𝗱𝗼𝗿 (◣_◢)凸', true],
  ['5535998872868'],
  ['5535998872868'],
  ['5535998872868']
];

global.suittag = ['5535998872868']
global.prems = []

global.libreria = 'Baileys'
global.baileys = 'fizzxydev/baileys-pro'
global.vs = '^2.0.5'
global.languaje = 'portugués'
global.nameqr = 'sticker bot - MD'
...
//• ↳ ◜𝑭𝑨𝑲𝑬 𝑬𝑺𝑻𝑰𝑳𝑶◞ • 🪩
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'sticker of kings✰⃔࿐', orderTitle: 'Bang', thumbnailUrl: logo, sellerJid: '0@s.whatsapp.net'}}}

//• ↳ ◜𝑳𝑰𝑵𝑲𝑺◞ • 🌿
global.ofcgp = '' //Grupo Oficial De Megumin
global.gp1 = '' //Grupo de Kotori Bot
global.gp2 = ''//Grupo de enlaces
global.comunidad1 = '' //Comunidad Megumin
global.channel = '' //Canal Oficial
global.channel2 = '' //Canal de Legends
